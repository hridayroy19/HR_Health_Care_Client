...
function AnimatedCounter({
  ...
  return (
    ...
    >
      <motion.div
        className={cn(
          "text-xl md:text-xl lg:text-4xl font-bold mb-2 sm:mb-4 whitespace-nowrap"
        )}
        initial={{ scale: 0.8 }}
  ...
  return (
    ...
    >
      ...
      >
        <h2
          className={cn(
            "text-sm sm:text-base md:text-lg lg:text-lg font-medium tracking-wide px-4"
          )}
        >
      ...
      <div className={cn("w-full  max-w-6xl mx-auto")}>  <div
          className={cn(
            "items-stretch grid lg:grid-cols-5 md:grid-cols-3 grid-cols-2 justify-between gap-2 sm:gap-4 lg:gap-8 w-full min-h-[120px] sm:min-h-[140px]"
          )}
        >
