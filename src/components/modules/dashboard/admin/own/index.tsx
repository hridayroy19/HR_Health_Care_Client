...
const userData = {
  ...
  backgroundImage:
    "https://images.unsplash.com/photo-1698656123481-93339003666b?q=80&w=1280&auto=format&fit=crop",
  followers: "2,4K",
  following: "541",
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
        ...
        <div className="w-full max-w-sm overflow-hidden rounded-xl bg-white shadow-xl transition-all duration-300 hover:shadow-2xl">
          {/* Background Image */}
